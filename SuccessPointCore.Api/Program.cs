...
using SuccessPointCore.Api.Filters;
using SuccessPointCore.Api.HttpHelper;
using SuccessPointCore.Api.Middlewares;
using SuccessPointCore.Domain.Helpers;
using SuccessPointCore.Infrastructure;
using SuccessPointCore.Infrastructure.Interfaces;
using SuccessPointCore.Infrastructure.Repositories;
...
builder.Services.AddControllersWithViews().AddJsonOptions(options =>
{
    ...
    options.JsonSerializerOptions.Converters.Add(new EmptyStringJsonConverter());
});
...
//        policyBuilder =>
//        {
//            policyBuilder.WithOrigins("https://sp.premiersolution.in", "https://premiersolution.in", "http://localhost:29233", "http://localhost:31770")
//                         .AllowAnyHeader()
//                         .AllowAnyMethod()
//                         .AllowCredentials();
//        });
...
//if (app.Environment.IsDevelopment())
//{
//    app.UseCors("AnyOrigin"); // Add CORS middleware here
//}
//else
//{
